...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3368992541ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="191">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yunisariamalia&table=users">`yunisariamalia`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yunisariamalia&table=tb_experience">`yunisariamalia`.`tb_experience`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yunisariamalia&table=tb_ctgy_experience">`yunisariamalia`.`tb_ctgy_experience`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yunisariamalia&table=tb_ctgy_awards">`yunisariamalia`.`tb_ctgy_awards`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yunisariamalia&table=tb_ctgy_publication">`yunisariamalia`.`tb_ctgy_publication`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yunisariamalia&table=tb_ctgy_about">`yunisariamalia`.`tb_ctgy_about`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yunisariamalia&table=tb_setting">`yunisariamalia`.`tb_setting`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yunisariamalia&table=tb_set_sosmed">`yunisariamalia`.`tb_set_sosmed`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yunisariamalia&table=tb_about">`yunisariamalia`.`tb_about`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yunisariamalia&table=tb_about_desc">`yunisariamalia`.`tb_about_desc`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4c40672e633552605a747868285a5878">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="191"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="yunisariamalia" targettable="tb_ctgy_experience">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_ctgy_experience`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="tb_setting">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_setting`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="tb_set_sosmed">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_set_sosmed`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="tb_setting">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_setting`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="tb_ctgy_about">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_ctgy_about`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="tb_ctgy_experience">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_ctgy_experience`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="tb_ctgy_publication">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_ctgy_publication`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="tb_ctgy_awards">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_ctgy_awards`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="yunisariamalia" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `yunisariamalia`.`users` ( `id` INT NOT NULL AUTO_INCREMENT ,  `username` VARCHAR(20) NOT NULL ,  `password` VARCHAR(255) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `users` (`id`, `username`, `password`) VALUES (NULL, &#039;admin&#039;, &#039;admin&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="tb_experience">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_experience`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yunisariamalia" targettable="tb_ctgy_experience">
                            <div class="action_content">
